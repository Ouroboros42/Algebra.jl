...
include("simplify/transforms/Transform.jl")
include("simplify/transforms/Substitute.jl")
include("simplify/checks.jl")
include("simplify/Simplifier.jl")
include("simplify/SimplifierSequence.jl")
include("simplify/Trivial.jl")
include("simplify/Approximate.jl")
include("simplify/core.jl")
